...
if ( ! function_exists( 'wpex_add_gallery_metabox' ) ) {
	function wpex_add_gallery_metabox() {
		// Portfolio
		add_meta_box( 'easy_image_gallery', esc_html__( 'Image Gallery', 'wptuts' ), 'wpex_gallery_metabox', 'portfolio', 'normal', 'high' );
	}
}
...
function wpex_gallery_metabox() {
					...
					if ( wp_attachment_is_image ( $attachment_id  ) ) { ?>
						<li class="image attachment details" data-attachment_id="<?php echo $attachment_id; ?>">
                        	<div class="attachment-preview"><div class="thumbnail">
								...
								<a href="#" class="wpex-gmb-remove" title="<?php esc_html_e( 'Remove image', 'wptuts' ); ?>"><div class="media-modal-icon"></div></a>	   
							</div>
                       </li>
					<?php }
				}
    ...
    <p class="add_gallery_images hide-if-no-js">
        <a href="#" class="button-secondary"><?php esc_html_e( 'Add/Edit Images', 'wptuts' ); ?></a>
    </p>
    <?php
    ...
    <p>
        <label for="easy_image_gallery_link_images">
            <input type="checkbox" id="easy_image_gallery_link_images" value="on" name="easy_image_gallery_link_images"<?php echo $checked; ?> /> <?php esc_html_e( 'Enable Lightbox for this gallery?', 'wptuts' )?>
        </label>
    </p>
        ...
        jQuery(document).ready(function($){
            ...
            jQuery('.add_gallery_images').on( 'click', 'a', function( event ) {
                ...
                image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                    ...
                    title: '<?php esc_html_e( 'Add Images to Gallery', 'wptuts' ); ?>',
                    button: {
                        text: '<?php esc_html_e( 'Add to gallery', 'wptuts' ); ?>',
                    },
                    multiple: true
                });
